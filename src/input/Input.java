...
public class Input extends GLFWKeyCallback {
    ...
    public static boolean GetKey(char keycode) {
        return keys[KeyEvent.getExtendedKeyCodeForChar(keycode)] == 1;
    }
    ...
    public static boolean GetKeyDown(int keycode) {
        return keysDown[keycode] == 1;
    }

    public static boolean GetKeyDown(char keycode) {
        return keysDown[KeyEvent.getExtendedKeyCodeForChar(keycode)] == 1;
    }
