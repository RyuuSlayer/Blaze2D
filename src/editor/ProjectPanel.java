...
public class ProjectPanel extends engine.Object {
    ...
    private final GUIStyle materialIcon;
    ...
    public void RenderAssets(Rect r) throws CloneNotSupportedException {
        ...
        if (selectedType == DataType.Font) {
            ...
            for (i = 0; i < fonts.size(); i++) {
                if (fonts.get(i).f != null) altered.add(fonts.get(i));
            }
            if (listView) {
            ...
            for (i = 0; i < materials.size(); i++) {
                if (materials.get(i).f != null) altered.add(materials.get(i));
            }
            ...
            for (i = 0; i < shaders.size(); i++) {
                if (shaders.get(i).f != null) altered.add(shaders.get(i));
            }
            ...
            for (i = 0; i < skins.size(); i++) {
                if (skins.get(i).f != null) altered.add(skins.get(i));
            }
            ...
            for (i = 0; i < sprites.size(); i++) {
                if (sprites.get(i).f != null) altered.add(sprites.get(i));
            }
            ...
            for (i = 0; i < textures.size(); i++) {
                if (textures.get(i).f != null) altered.add(textures.get(i));
            }
            ...
            for (i = 0; i < clips.size(); i++) {
                if (clips.get(i).f != null) altered.add(clips.get(i));
            }
            ...
            for (i = 0; i < scenes.size(); i++) {
                if (scenes.get(i).f != null) altered.add(scenes.get(i));
            }
